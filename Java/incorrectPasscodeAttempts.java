...
public class incorrectPasscodeAttempts {
	static String passcode = "2222";
	static String attempts[] = {"1111", 
					 "4444", 
					 "9999", 
					 "3333", 
					 "8888", 
	...
	static boolean incorrectPasscodeAttempts(String passcode, String[] attempts) {
		...
		{
			if (passcode.compareTo(attempts[i]) == 0)
			{
				if (cons < 10) cons = 0;
			}
			else
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Result: " + incorrectPasscodeAttempts(passcode, attempts));
    }
